...
## Find company personnal names () linked to multiple companies, that's anomalies. 
...
2. All of the id type is "Company", surprisingly no beneficial owners and company contacts. Sort of expected looking from the distribution of types for Node dataframe intiially, but it might be noteworthy to investigate further what id type mean for illegal fishery. 
